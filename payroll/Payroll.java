 ...
 * The Payroll system.
 *
 * The system reads an employees data file, and a deductions data file to create
 * a list of employees to be paid. Then, for each employee, their gross pay,
 * total deductions, and net pay are calculated.
 *****************************************************************************/
import java.io.*;
import java.util.*;
...
public class Payroll {
    ...
    public static void main(String args[]) {
        ...
        Map employees = parseEmployeesFile(employeeFile);
    ...
    /*************************************************************************
     * Reads and parses the specified employees file, returning a Map of
     * employees.
     *
     * @param employeeFile The file containing the employees.
     *
     * @return a Map of employees
     *************************************************************************/
    public static Map parseEmployeesFile(String employeeFile) {
    ...
    /*************************************************************************
     * Reads and parses the specified deduction file, adding each deduction to
     * the corresponding employee.
     *
     * @param deductionFile The file of deductions.
